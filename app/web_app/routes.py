...
from app.web_app.forms import LoginForm, RegistrationForm, AnnouncementForm, EventForm
from app.web_app.models import Staff, StaffAccount, PermittedCourse
from app import login_manager, db
from werkzeug.urls import url_parse
from flask_login import login_required, login_user, logout_user, current_user
from app.mobile import Student
...
def save_announcement_rc():
    ...
    print(session['announcement_form'])
...
def announcement_preview():
    # Get announcement and recipient data from session
    # append these data to the page
    return render_template('announcement_preview.html')

@web.route('/send_announcement')
@login_required
