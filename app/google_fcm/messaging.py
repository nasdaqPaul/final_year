...
def send_to_token(token, in_data):
    ...
    # registration_token = 'ddFjljyt-j8:APA91bFydMGz4A8uIbg97t_dsVd2aq_ZpNpHGVs-LYE5wzgdlPXmX2S_lxl2zTsKsTQkhnAahkoJVsRtCvm2Hy_ciptJxXnFEPrEcOeQ9oOe3RCdQc9fgaJY4H_a2gxaNkhw_wGShQ-7'
